...
<body>
   ...
   <nav class="navbar navbar-inverse">
    ...
    <div class="row">
        <div class="container">
            <div class="col-sm-6">
                <form action="includes/classes/process_login.php" class="form-horizontal" method="post">
                    <?php 
                        session_start();
                        if (isset($_SESSION['error'])) {
                            # code...
                            echo "<small><i>" . $_SESSION['error'] . "</i></small><br/>";
                            session_destroy();
                        }
                    ?>
                    <div class="form-group">
                    ...
                    <p class="text-center">
                        <marquee  direction="rtl">
                           <i> The time is now, this is the future.</i>
                        </marquee>
                    </p>
                    <img src="images/banner-taow.png" alt="">
                </form>
            </div>
            <div class="col-sm-6">
  \              <div class="card">
